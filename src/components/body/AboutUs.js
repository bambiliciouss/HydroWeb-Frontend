              ...
              <Col md="6">
                <div className="pr-md-5 text-center">
                  ...
                  <p>
                    ...
                    from a nearby water station once you've signed up!
                  </p>
                </div>
              </Col>
            </Row>
            ...
            <Row className="row-grid align-items-center">
              ...
              <Col className="order-md-1" md="6">
                <div className="pr-md-5">
                  <h1 className="display-3 text-info">Water Refilling Station</h1>
                  <p>
                    Water Refilling Station is your go-to location for clean,
                    pure, and sustainable refreshment. Our water undergoes
                    21 stages of filtration, ensuring it's safe to drink.
                  </p>
                </div>
              </Col>
            </Row>
            ...
            <Row className="mt-5">
              <Col lg="4" md="6" className="mb-4">
                <div className="cover text-center p-4 shadow-md bg-white">
                  ...
                  <p>
                    Our app offers an experience of hassle-free ordering.
                    You can quickly place orders, schedule delivery, and 
              ...
              <Col lg="4" md="6" className="mb-4">
                <div className="cover text-center p-4 shadow-md bg-white">
                  ...
                  <p>
                    Our app provides a seamless payment process, allowing you 
                    to make transactions with just a few taps.
                  </p>
                </div>
              </Col>
              <Col lg="4" md="6" className="mb-4">
                <div className="cover text-center p-4 shadow-md bg-white">
                  ...
                  />
                  <h2 className="fs-4 fw-bolder mt-4">Quality and Reliability</h2>
                  <p>
                    We ensure that our water meets high standards for safety 
                    and cleanliness, providing a reliable source of hydration.
                  </p>
                </div>
              </Col>
            </Row>
