...
export const getAllUserReviewsByBranch =
  (id, month = "1", year = "2024") =>
  async (dispatch) => {
    try {
      dispatch({ type: GET_ADMIN_REVIEW_REQUEST });
      const { data } = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/admin/reviews/${id}/?month=${month}&year=${year}`,
...
export const updateSingleReview = (id, reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_API}/api/v1/user/review/${id}`,
      reviewData,
      config
    );
    dispatch({
...
export const createReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_API}/api/v1/create/review`,
      reviewData,
      config
    );
    dispatch({
...
export const getUserReviews = (id, order) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/user/reviews/${id}/${order}`,
      { withCredentials: true }
    );
    dispatch({
...
export const deleteReview = (comment) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${process.env.REACT_APP_API}/api/v1/user/review/${comment}`,
      { withCredentials: true }
    );
    dispatch({
...
export const allStoreSalesAction =
  (id, filter = "") =>
  async (dispatch) => {
    try {
      dispatch({ type: ALL_STORE_SALES_REQUEST });
      const { data } = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/admin/all/store/sales/${id}/?filter=${filter}`,
        { withCredentials: true }
      );
      dispatch({
...
export const getSalesOrderByBranch = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/all/sales/order/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const getSalesOrderByBranchEmployee = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/employee/all/sales/order/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const getSalesOrderByBarangay = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/orders/byBarangay/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const getSingleBranchUsers = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/store/customer/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const getAllStaff = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/store/staff/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const getSalesWalkin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/sales/othergallon/inventory`,
      { withCredentials: true }
    );
...
export const getOrderTransactions =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/admin/all/orders/${id}/?filter=${filter}`,
        { withCredentials: true }
      );
      dispatch({
...
export const getOrderByGallonType =
  (id, filter = "") =>
  async (dispatch) => {
    try {
      dispatch({ type: ALL_ORDER_GALLON_TYPE_REQUEST });
      const { data } = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/admin/orders/byGallon/${id}/?filter=${filter}`,
        { withCredentials: true }
      );
      dispatch({
...
export const getStaffPerformance =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/admin/orders/staff/${id}/?month=${month}&year=${year}`,
        { withCredentials: true }
      );
      dispatch({
...
export const getCurrentBranchSales =
  (id, filter = "today") =>
  async (dispatch) => {
    try {
      dispatch({ type: CURRENT_STORE_SALES_REQUEST });
      const { data } = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/admin/all/current/sales/${id}/?filter=${filter}`,
        { withCredentials: true }
      );
      dispatch({
...
export const getEmployeeBranch = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/employee/branch/${id}`,
      { withCredentials: true }
    );
    dispatch({
