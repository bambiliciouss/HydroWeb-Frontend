...
export const adminregister = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_API}/api/v1/register/admin`,
      userData,
      config
    );
    dispatch({
...
export const allUsers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/store/users`,
      { withCredentials: true }
    );
    dispatch({
...
export const allEmployee = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/store/employee/${id}`,
      { withCredentials: true }
    );
...
export const allRider = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/store/rider/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const getUserQRDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/user/qr/${id}`,
      config
    );
...
export const getStaffDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/staff/${id}`,
      config
    );
