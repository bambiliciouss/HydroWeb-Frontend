...
export const allStoreBranch = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/storebranch`,
      { withCredentials: true }
    );
    dispatch({
...
export const allStoreBranchUser = () => async (dispatch) => {
  try {
    dispatch({ type: ALL_STOREBRANCH_REQUEST });
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/available/store`,
      { withCredentials: true }
    );
    dispatch({
      type: ALL_STOREBRANCH_SUCCESS,
...
export const allAdminStoreBranch = () => async (dispatch) => {
  try {
    dispatch({ type: ALL_STOREBRANCH_REQUEST });
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/all/store`,
      { withCredentials: true }
    );
    dispatch({
      type: ALL_STOREBRANCH_SUCCESS,
...
export const allAdminBranches = (id) => async (dispatch) => {
  try {
    dispatch({ type: ALL_STOREBRANCH_REQUEST });
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/all/store/branches/${id}`,
      { withCredentials: true }
    );
    dispatch({
      type: ALL_STOREBRANCH_SUCCESS,
...
export const deleteStoreBranch = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${process.env.REACT_APP_API}/api/v1/delete/storebranch/${id}`,
      {
        withCredentials: true,
      }
    );
